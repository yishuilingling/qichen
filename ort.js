+function(){
    ...
    function adaptUILayout(){
        ...
        if(devicePixelRatio==2 && (deviceWidth==320 || deviceWidth==360 || deviceWidth==592 || deviceWidth==425)){
            deviceWidth*=2;
        }
        ...
        if(devicePixelRatio==1.5 && (deviceWidth==425)){
            devicePixelRatio = 2;
        }

        //鑾峰彇鏈€缁坉pi
        targetDensitydpi = 425 / deviceWidth * devicePixelRatio * 160;
        initialContent   = isiOS 
            ? 'width=' + 425 + 'px, user-scalable=no, minimal-ui'
            : 'target-densitydpi=' + targetDensitydpi + ', width='+ 425 +', user-scalable=no, minimal-ui';
